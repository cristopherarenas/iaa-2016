...
int main(int argc, char **argv)
{
	...
	*/	
	...
	if(p_fo <= 100){
		cout << "ejecuntando con alpha =" << (p_fo/100.0) << " beta =" << ((100-p_fo)/100.0) << endl;
	}
	...
	stringstream sstr4;
	if(p_fo<=100){
		sstr4 << "results/" << opt_seed << "_hypervolumen" << "_alpha_" << p_fo << "_beta_" << (100-p_fo) << "_af_" << afinidad << "_cl_" << porc_clones << "_re_" << porc_reemplazo << "_ps_" << popsize << "_cs_" << clonsize << ".txt";
	}
	else{
		sstr4 << "results/" << opt_seed << "_auto_hypervolumen" << "_af_" << afinidad << "_cl_" << porc_clones << "_re_" << porc_reemplazo << "_ps_" << popsize << "_cs_" << clonsize << ".txt";
	}
	...
	if(p_fo<=100){
		...
		sstr6 << "results/hypervolumen" << "_auto" << ".txt";
	}
	...
	archivo6 << opt_seed << ": af:" << afinidad << " cl:" << porc_clones << " re:" << porc_reemplazo << " ps:" << popsize << " cs:" << clonsize << " " << hiper[hiper.size()-1] << endl;
	...
	*/
	...
	stringstream sstr5;
	if(p_fo<=100){
		sstr5 << "results/" << opt_seed << "_time" << "_alpha_" << p_fo << "_beta_" << (100-p_fo) << "_af_" << afinidad << "_cl_" << porc_clones << "_re_" << porc_reemplazo << "_ps_" << popsize << "_cs_" << clonsize << ".txt";
	}
	else{
		sstr5 << "results/" << opt_seed << "_auto_time" << "_af_" << afinidad << "_cl_" << porc_clones << "_re_" << porc_reemplazo << "_ps_" << popsize << "_cs_" << clonsize << ".txt";
	}
